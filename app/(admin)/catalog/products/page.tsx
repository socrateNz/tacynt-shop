    ...
    async (tx) => {
      const products = await tx.product.findMany({
        ...
        include: {
          ...
          // Juste les id (pour construire les URLs), jamais imageData
          // (bytea) ici — c'est exactement pour éviter cet alourdissement
          // que ProductImage est un modèle séparé de Product.
